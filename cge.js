...
// include: C:\Users\ARLOTA~1\AppData\Local\Temp\tmp1jwtaymw.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'web/cge.data';
      var REMOTE_PACKAGE_BASE = 'cge.data';
...
Module['FS_createPath']("/assets", "runtime", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_web/cge.data');

      };
      Module['addRunDependency']('datafile_web/cge.data');
    ...
    loadPackage({"files": [{"filename": "/assets/runtime/Kings.inter", "start": 0, "end": 6794}, {"filename": "/assets/runtime/catalogue.txt", "start": 6794, "end": 8033}, {"filename": "/assets/runtime/standard-deck.CARDS", "start": 8033, "end": 9831}, {"filename": "/assets/runtime/standard-deck.png", "start": 9831, "end": 4057526}], "remote_package_size": 4057526});

  })();

// end include: C:\Users\ARLOTA~1\AppData\Local\Temp\tmp1jwtaymw.js
// include: C:\Users\ARLOTA~1\AppData\Local\Temp\tmp4n5hxtjn.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\ARLOTA~1\AppData\Local\Temp\tmp4n5hxtjn.js
// include: C:\Users\ARLOTA~1\AppData\Local\Temp\tmpco1qnnly.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\ARLOTA~1\AppData\Local\Temp\tmpco1qnnly.js
...
var ASM_CONSTS = {
  120956: () => { if (document.fullscreenElement) return 1; },  
 121002: () => { return document.getElementById('canvas').width; },  
 121054: () => { return parseInt(document.getElementById('canvas').style.width); },  
 121122: () => { document.exitFullscreen(); },  
 121149: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 121222: () => { if (document.fullscreenElement) return 1; },  
 121268: () => { return document.getElementById('canvas').width; },  
 121320: () => { return screen.width; },  
 121345: () => { document.exitFullscreen(); },  
 121372: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 121505: () => { return window.innerWidth; },  
 121531: () => { return window.innerHeight; },  
 121558: () => { if (document.fullscreenElement) return 1; },  
 121604: () => { return document.getElementById('canvas').width; },  
 121656: () => { return parseInt(document.getElementById('canvas').style.width); },  
 121724: () => { if (document.fullscreenElement) return 1; },  
 121770: () => { return document.getElementById('canvas').width; },  
 121822: () => { return screen.width; },  
 121847: () => { return window.innerWidth; },  
 121873: () => { return window.innerHeight; },  
 121900: () => { if (document.fullscreenElement) return 1; },  
 121946: () => { return document.getElementById('canvas').width; },  
 121998: () => { return screen.width; },  
 122023: () => { document.exitFullscreen(); },  
 122050: () => { if (document.fullscreenElement) return 1; },  
 122096: () => { return document.getElementById('canvas').width; },  
 122148: () => { return parseInt(document.getElementById('canvas').style.width); },  
 122216: () => { document.exitFullscreen(); },  
 122243: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 122301: () => { return screen.width; },  
 122326: () => { return screen.height; },  
 122352: () => { return window.screenX; },  
 122379: () => { return window.screenY; },  
 122406: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 122459: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 122530: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 122587: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 122843: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 122914: () => { if (document.fullscreenElement) return 1; },  
 122960: () => { return window.innerWidth; },  
 122986: () => { return window.innerHeight; },  
 123013: () => { if (document.pointerLockElement) return 1; }
};
